...
public class ExtractorMenu extends WorkstationMenu<ExtractorRecipe, ExtractorBlockEntity> {
    ...
    public ExtractorMenu(int syncId, Inventory inventory, BlockEntity entity, SimpleContainerData arrayPropertyDelegate) {
        super(SubstanceCraftMenus.EXTRACTOR, syncId, inventory, (ExtractorBlockEntity) entity, arrayPropertyDelegate);
    }
}
