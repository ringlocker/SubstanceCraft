...
public class OxidizerMenu extends WorkstationMenu<OxidizerRecipe, OxidizerBlockEntity> {
    ...
    public OxidizerMenu(int syncId, Inventory inventory, BlockEntity entity, SimpleContainerData arrayPropertyDelegate) {
        super(SubstanceCraftMenus.OXIDIZER, syncId, inventory, (OxidizerBlockEntity) entity, arrayPropertyDelegate);
    }
