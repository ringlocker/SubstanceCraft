...
public class HashPressMenu extends WorkstationMenu<HashPressRecipe, HashPressBlockEntity> {
    ...
    public HashPressMenu(int syncId, Inventory inventory, BlockEntity entity, SimpleContainerData arrayPropertyDelegate) {
        super(SubstanceCraftMenus.HASH_PRESS, syncId, inventory, (HashPressBlockEntity) entity, arrayPropertyDelegate);
    }
