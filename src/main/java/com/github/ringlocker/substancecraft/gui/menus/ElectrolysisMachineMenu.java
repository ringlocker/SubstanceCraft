...
public class ElectrolysisMachineMenu extends WorkstationMenu<ElectrolysisRecipe, ElectrolysisMachineBlockEntity> {
    ...
    public ElectrolysisMachineMenu(int syncId, Inventory inventory, BlockEntity entity, SimpleContainerData arrayPropertyDelegate) {
        super(SubstanceCraftMenus.ELECTROLYSIS_MACHINE, syncId, inventory, (ElectrolysisMachineBlockEntity) entity, arrayPropertyDelegate);
    }
