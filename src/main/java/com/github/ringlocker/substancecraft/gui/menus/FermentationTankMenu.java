...
public class FermentationTankMenu extends WorkstationMenu<FermentationTankRecipe, FermentationTankBlockEntity> {
    ...
    public FermentationTankMenu(int syncId, Inventory inventory, BlockEntity entity, SimpleContainerData arrayPropertyDelegate) {
        super(SubstanceCraftMenus.FERMENTATION_TANK, syncId, inventory, (FermentationTankBlockEntity) entity, arrayPropertyDelegate);
    }
