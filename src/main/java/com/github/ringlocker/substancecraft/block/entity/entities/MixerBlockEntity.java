...
public class MixerBlockEntity extends WorkstationBlockEntity<MixerRecipe> {

    public MixerBlockEntity(BlockPos pos, BlockState state) {
        super(SubstanceCraftBlockEntities.MIXER, MixerRecipe.Type.INSTANCE,  pos, state, "Mixer");
    }
