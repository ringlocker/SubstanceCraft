...
public class SubstanceCraftBlockEntities {
    ...
    public static final BlockEntityType<HashPressBlockEntity> HASH_PRESS =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath(SubstanceCraft.MOD_ID, "hash_press"),
    ...
    public static final BlockEntityType<RefineryBlockEntity> REFINERY =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath(SubstanceCraft.MOD_ID, "refinery"),
    ...
    public static final BlockEntityType<ElectrolysisMachineBlockEntity> ELECTROLYSIS_MACHINE =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath(SubstanceCraft.MOD_ID, "electrolysis_machine"),
    ...
    public static final BlockEntityType<OxidizerBlockEntity> OXIDIZER =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath(SubstanceCraft.MOD_ID, "oxidizer"),
    ...
    public static final BlockEntityType<ExtractorBlockEntity> EXTRACTOR =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath(SubstanceCraft.MOD_ID, "extractor"),
    ...
    public static final BlockEntityType<MixerBlockEntity> MIXER =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath(SubstanceCraft.MOD_ID, "mixer"),
    ...
    public static final BlockEntityType<HeatedMixerBlockEntity> HEATED_MIXER =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath(SubstanceCraft.MOD_ID, "heated_mixer"),
    ...
    public static final BlockEntityType<FermentationTankBlockEntity> FERMENTATION_TANK =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath(SubstanceCraft.MOD_ID, "fermentation_tank"),
