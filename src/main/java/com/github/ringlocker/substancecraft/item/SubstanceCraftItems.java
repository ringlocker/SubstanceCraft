...
public class SubstanceCraftItems {
    ...
    public static final Item AMPHETAMINE = registerItem("amphetamine", properties -> new DrugItem(properties, Drug.TWO_CB), alwaysEatProperties());
    ...
    public static final Item COCAINE = registerItem("cocaine", properties -> new DrugItem(properties, Drug.TWO_CB), alwaysEatProperties());
    ...
    public static final Item CALCIUM_HYDROXIDE = registerItem("calcium_hydroxide", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.LIQUID), new Item.Properties());
    ...
    public static final Item TARTARIC_ACID = registerItem("tartaric_acid", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.LIQUID), new Item.Properties());
    public static final Item ERGOTAMINE = registerItem("ergotamine", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    public static final Item ERGOTAMINE_TARTRATE = registerItem("ergotamine_tartrate", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    public static final Item DIETHYL_ETHER = registerItem("diethyl_ether", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    public static final Item ERGOTAMINE_SULFATE = registerItem("ergotamine_sulfate", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    public static final Item SILICA = registerItem("silica", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    ...
    public static final Item RED_PHOSPHORUS = registerItem("red_phosphorus", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    public static final Item PHOSPHORUS_TRICHLORIDE = registerItem("phosphorus_trichloride", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    public static final Item PHOSPHORYL_CHLORIDE = registerItem("phosphoryl_chloride", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    public static final Item DIETHYLENE = registerItem("diethylene", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    public static final Item D_LYSERGIC_ACID_HYDRATE = registerItem("d_lysergic_acid_hydrate", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
    public static final Item MAGNESIUM = registerItem("magnesium", properties -> new SubstanceItem(properties, SubstanceTintColors.WHITE_SOLID, MatterState.SOLID), new Item.Properties());
